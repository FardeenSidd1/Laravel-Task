                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form" method="POST"
                                    @if (!empty($blogPost)) action="{{ route('admin.blog-posts.store', $blogPost->id) }}"@else action = "{{ route('admin.blog-posts.store') }}" @endif enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="content" rows="5" class="form-control" name="content" placeholder="Content">{{ !empty(old('content'))? old('content'): (!empty($blogPost->content)? $blogPost->content: '') }}</textarea>
                                        </div>
